...
public class Constitution extends RecyclerView.Adapter implements OnDataReady
{
    List<Object> itemList;
    Context context;
    Constitution constitution;

    public Constitution(Context c)
    {
        context = c;
        ...
        params.put("search_query", "Constitution");
        ...
        try
        {
            ...
            if (jsonObject.getBoolean("success"))
            {
                for(int i=0;i<jsonArray.length();i++)
                {
                    ...
                    constitution.notifyDataSetChanged();
                }
            }
            else
            {
