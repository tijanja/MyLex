...
public class Procurement extends RecyclerView.Adapter implements OnDataReady
{
    List<Object> itemList;
    Context context;
    Procurement procurement;

    public Procurement(Context c)
    {
        context = c;
        ...
        params.put("search_query", "procurement");
        ...
        try
        {
            ...
            if (jsonObject.getBoolean("success"))
            {
                for(int i=0;i<jsonArray.length();i++)
                {
                    ...
                    procurement.notifyDataSetChanged();
                }
            }
            else
            {
