...
public class CriminalLaw extends RecyclerView.Adapter implements OnDataReady
{
    List<Object> itemList;
    Context context;
    CriminalLaw criminalLaw;

    public CriminalLaw(Context c)
    {
        context = c;
        ...
        params.put("search_query", "Criminal Law");
        ...
        try
        {
            ...
            if (jsonObject.getBoolean("success"))
            {
                for(int i=0;i<jsonArray.length();i++)
                {
                    ...
                    criminalLaw.notifyDataSetChanged();
                }
            }
            else
            {
